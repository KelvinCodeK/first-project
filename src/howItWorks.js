    ...
    render() {
        return (
            <div className="howItWorks">
                <h1>Hoe het werkt</h1>
                <p>Door online zoekvolume en weerdata te combineren krijg je inzicht in:</p>
                <ul>
                ...
                <button className="buttonTwee" onClick={this.props.onClickHowToGo}>aan de slag!</button>
            </div>
        )
    }
}