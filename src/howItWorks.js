    ...
    render() {
        ...
        return (
            <div className="howItWorks">
                ...
                <ul>
                    <li>{this.props.Language === 'dutch' ? 'Optimale verkoopmomenten door het jaar heen' : 'Optimal moments to sell throughout the year'}</li>
                    <li>{this.props.Language === 'dutch' ? 'Of warme/koude dagen jouw online verkoop kunnen beïnvloeden' : 'Whether warm/cold days influence your online sales'}</li>
                    <li>{this.props.Language === 'dutch' ? 'De producten die het meest worden beïnvloed door het weer' : 'Which products are most affected by the weather'}</li>
                </ul>
